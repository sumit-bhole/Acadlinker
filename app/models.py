...
class Notification(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'))  # Who should receive it
    message = db.Column(db.String(200))
    link = db.Column(db.String(200))  # Where to go on click
...
class User(db.Model, UserMixin):
    ...
    cover_photo = db.Column(db.String(20), default='cover.jpg')
